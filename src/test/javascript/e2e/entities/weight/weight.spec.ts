...
describe('Weight e2e test', () => {
    ...
    it('should create and save Weights', () => {
        weightComponentsPage.clickOnCreateButton();
        weightUpdatePage.setDatetimeInput('01/01/2001' + protractor.Key.TAB + '02:30AM');
        expect(weightUpdatePage.getDatetimeInput()).toContain('2001-01-01T02:30');
        weightUpdatePage.setWeigthInput('5');
        expect(weightUpdatePage.getWeigthInput()).toMatch('5');
